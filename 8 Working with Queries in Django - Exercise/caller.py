...
def show_highest_rated_art():
    result = ArtworkGallery.objects.order_by("-rating", "id").first()
    return f"{result.art_name} is the highest-rated art with a {result.rating} rating!"
...
def delete_workouts():
    Workout.objects.exclude(workout_type="Strength").exclude(workout_type="Calisthenics").delete()
